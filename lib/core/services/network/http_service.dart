...
class HttpService {
  ...
  Future<Map<String, String>> _getHeaders({Map<String, String>? additionalHeaders}) async {
    ...
    if (additionalHeaders != null) {
      ...
      if (authorizationValue != null) {
        final formatToken = 'Bearer ${ await _getToken(authorizationValue)}';
  ...
  Future<void> _saveToken(String tokenName, String token) async {
    await encryptionService.saveString(tokenName, token);
  }

  Future<String?> _getToken(String tokenName) async {
    return await encryptionService.getString(tokenName);
  }
  ...
  Future<http.Response> get(
    ...
    try {
      ...
      final response = await http
          .get(uri, headers: await _getHeaders(additionalHeaders: headers))
          .timeout(timeOut);
  ...
  Future<http.Response> _multipartRequest(
    ...
    try {
      ...
      if (headers != null) {
        ...
        if (authorizationValue != null) {
          final token = await _getToken(authorizationValue);
          if (token != null) {
